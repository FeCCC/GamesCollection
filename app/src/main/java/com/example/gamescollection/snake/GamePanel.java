...
public class GamePanel extends View implements OnTouchListener{
    ...
    public ArrayList<com.example.gamescollection.snake.SnackBody> body = new ArrayList<com.example.gamescollection.snake.SnackBody>();//蛇身
    public int score;//分数
    ...
    public void startGame() {
        init();
        start = true;
        com.example.gamescollection.snake.SnackBody newBody = new com.example.gamescollection.snake.SnackBody();
        newBody.setX(MAX_Width / 2);
        newBody.setY(MAX_Height / 2);
        com.example.gamescollection.snake.SnackBody newBody2 = new com.example.gamescollection.snake.SnackBody();
    ...
    public void eat() {
        ...
        com.example.gamescollection.snake.SnackBody growBody = new com.example.gamescollection.snake.SnackBody();
